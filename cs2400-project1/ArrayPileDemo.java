/**
A test for arrayPile, which tests for all the method in the class.
@author Harrison B. Chen
@version 1.0
*/
public class ArrayPileDemo {

	public static void main(String[] args) {
		// A pile whose initial capacity is small
		PileInterface<String> pileOfBooks;
		try {
			pileOfBooks = new ArrayPile<>(3);
	...
	private static void testAdd(PileInterface<String> aPile, String[] content) {
