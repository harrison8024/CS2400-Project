/**
A test for LinkedStack, which tests for all the method in the class.
...
public class LinkedStackTest {
	...
	public static void main(String[] args) throws IntegrityException {
		...
		stackOfElements = new LinkedStack<>();
	...
	private static void testAdd(StackInterface<String> aStack, String[] content) throws IntegrityException {
